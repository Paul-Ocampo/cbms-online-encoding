...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    ...
    <nav>
      ...
      <li class="breadcrumb-item active"><a>Surveyed Households | Pending for Validation</a></li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card shadow mb-4">
          <div class="card-body">
            <h5 class="card-title">Surveyed Households <span>| Pending for Validation</span></h5>
